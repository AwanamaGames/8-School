...
public class SoundEffectSO : ScriptableObject
{
    ...
    #region Tooltip
    [Tooltip("The Minimum pitch variation for sound effect. A random pitch variation will be generated between the minimum and maximum values." +
    ...
    #region Tooltip
    [Tooltip("The Maximum pitch variation for sound effect. A random pitch variation will be generated between the minimum and maximum values." +
        "A random pitch variation makes sound effects sound more natural")]
    #endregion
    [Range(0.1f, 1.5f)]
